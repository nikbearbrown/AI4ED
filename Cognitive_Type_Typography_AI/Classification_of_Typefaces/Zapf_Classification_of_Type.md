...
Abecedarian is a lexical database crafted specifically for enhancing "text to type" foundation models through a unique integration of lexicographic information and visual representations of typographic terms. Unlike traditional dictionaries designed with human readers in mind, Abecedarian caters to the needs of machines, providing a seamless bridge between textual descriptions and visual typographic concepts. This database organizes English typographic terms into synonym sets, including translations in various languages, each encapsulating a distinct typographic idea. These sets are interconnected through semantic relationships, allowing for each typographic term to be associated with multiple images that visually embody the concept.
...
Abecedarian integrates terms from Google Fonts' extensive library of over 1,500 open-source and free fonts, enabling typographers to design new typefaces inspired by existing ones.
